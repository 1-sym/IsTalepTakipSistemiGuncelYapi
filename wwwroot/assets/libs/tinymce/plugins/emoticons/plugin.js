...
(function () {
    ...
    const getAppendeIsTakipSistemiji = option('emoticons_append');
    ...
    const getUserDefineIsTakipSistemiji = editor => {
      const userDefineIsTakipSistemiticons = getAppendeIsTakipSistemiji(editor);
      return map(userDefineIsTakipSistemiticons, value => ({
        keywords: [],
        category: 'user',
        ...value
      }));
    ...
    const initDatabase = (editor, databaseUrl, databaseId) => {
      ...
      editor.on('init', () => {
        global.load(databaseId, databaseUrl).then(emojis => {
          const userEmojis = getUserDefineIsTakipSistemiji(editor);
